...
import {
  ...
  User, Calendar, DollarSign, ChevronDown
} from 'lucide-react'
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500 mt-1">{filtered.length} deals</p>
        </div>
        {canCreate && (
      ...
      {loading ? (
        ...
        <div className="text-center py-12">
          ...
          {canCreate && (
            <Link href="/dashboard/deals/new">
              <Button><Plus className="w-4 h-4" /> Create first deal</Button>
            </Link>
          )}
        </div>
      ) : (
                  ...
                  <div className="space-y-1.5 text-sm text-gray-500">
                    {deal.quotedAmount && (
                      <div className="flex items-center gap-1.5">
                        ...
                        <span className="font-medium text-gray-900">{formatCurrency(deal.quotedAmount)}</span>
                      </div>
                    )}
                    {deal.assignedTo && (
                      <div className="flex items-center gap-1.5">
